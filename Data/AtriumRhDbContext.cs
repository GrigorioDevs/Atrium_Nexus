...
namespace Atrium.RH.Data
{
    public class AtriumRhDbContext : DbContext
    {
        ...
        public DbSet<FuncionarioAssinaturaGif> FuncionariosAssinaturaGif => Set<FuncionarioAssinaturaGif>();

        // ===== TEMPLATES DOCUMENTOS =====
        public DbSet<DocumentoTemplate> DocumentosTemplates => Set<DocumentoTemplate>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PontoRegistro>(p =>
            {
                ...
                p.Property(x => x.Latitude).HasColumnName("latitude").HasColumnType("decimal(9,6)");
                p.Property(x => x.Longitude).HasColumnName("longitude").HasColumnType("decimal(9,6)");
            ...
            modelBuilder.Entity<FuncDocImpTipo>(e =>
            {
                ...
                e.Property(x => x.Alteracao).HasColumnName("alteracao").HasColumnType("datetime2");
                e.Property(x => x.DataSincronizacao).HasColumnName("datassincronizacao").HasColumnType("datetime2");
                e.Property(x => x.DataInterface).HasColumnName("datainterface").HasColumnType("datetime2");
            ...
            modelBuilder.Entity<Curso>(c =>
            {
                ...
                c.Property(x => x.Ativo).HasColumnName("ativo").HasDefaultValue(true);
                ...
                c.Property(x => x.Alteracao).HasColumnName("alteracao").HasPrecision(0);
                c.Property(x => x.DataSincronizacao).HasColumnName("datassincronizacao").HasPrecision(0);
                c.Property(x => x.DataInterface).HasColumnName("datainterface").HasPrecision(0);

                c.Property(x => x.Nome).HasColumnName("nome").HasMaxLength(200).IsRequired();
                c.Property(x => x.CargaHoraria).HasColumnName("carga_horaria");
                ...
                c.Property(x => x.Observacao).HasColumnName("observacao").HasMaxLength(200);
                c.Property(x => x.Descricao).HasColumnName("descricao").HasMaxLength(800);

                c.Property(x => x.UsuarioCriacaoId).HasColumnName("usuariocriacaoid").IsRequired();
                c.Property(x => x.UsuarioId).HasColumnName("usuarioid");
            });
            ...
            modelBuilder.Entity<FuncionarioCurso>(fc =>
            {
                ...
                fc.Property(x => x.FuncionarioId).HasColumnName("funcionarioid").IsRequired();
                fc.Property(x => x.CursoId).HasColumnName("cursoid").IsRequired();

                fc.Property(x => x.DataConclusao).HasColumnName("data_conclusao").HasColumnType("date").IsRequired();
                fc.Property(x => x.DataValidade).HasColumnName("data_validade").HasColumnType("date");

                fc.Property(x => x.Ativo).HasColumnName("ativo").HasDefaultValue(true);
                ...
                fc.Property(x => x.Alteracao).HasColumnName("alteracao").HasPrecision(0);
                fc.Property(x => x.DataSincronizacao).HasColumnName("datassincronizacao").HasPrecision(0);
                fc.Property(x => x.DataInterface).HasColumnName("datainterface").HasPrecision(0);

                fc.Property(x => x.UsuarioCriacaoId).HasColumnName("usuariocriacaoid").IsRequired();
                fc.Property(x => x.UsuarioId).HasColumnName("usuarioid");
            ...
            // ======================================================
            // ✅ FUNCIONARIO_ASSINATURA_GIF (TABELA funcionarios_assinatura_gif) — AJUSTADO
            // ======================================================
            modelBuilder.Entity<FuncionarioAssinaturaGif>(e =>
            {
                e.ToTable("funcionarios_assinatura_gif");
                ...
                e.HasOne<Funcionario>()
                    .WithMany()
                    .HasForeignKey(x => x.FuncionarioId)
                    .HasConstraintName("FK_func_ass_gif_funcionario")
                    .OnDelete(DeleteBehavior.NoAction);

                // (opcional, recomendado) otimiza busca da assinatura ativa
                e.HasIndex(x => new { x.FuncionarioId, x.Ativa })
                    .HasDatabaseName("IX_func_ass_gif_funcionario_ativa");
            });

            // ======================================================
            // ✅ DOCUMENTO_TEMPLATE
            // ======================================================
            modelBuilder.Entity<DocumentoTemplate>(e =>
            {
                e.ToTable("documentos_templates");
                e.HasKey(x => x.Id);
